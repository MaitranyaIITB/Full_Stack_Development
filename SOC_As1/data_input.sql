...
create table department(
    dept_name VARCHAR(100) NOT NULL PRIMARY KEY,
    building VARCHAR(100) NOT NULL,
    budget NUMERIC(19) NOT NULL
);
...
create table section(
    course_id VARCHAR(100) REFERENCES course(course_id),
    sec_id INT NOT NULL,
    ...
    FOREIGN KEY(time_slot_id,day) REFERENCES time_slot(time_slot_id,day)
);

create table prereq(
    course_id VARCHAR(100) REFERENCES course(course_id),
    prereq_id VARCHAR(100) REFERENCES course(course_id),
...
create table advisor(
    s_id VARCHAR(50) REFERENCES student(ID),
    i_id VARCHAR(50) REFERENCES instructor(ID),
    PRIMARY KEY(s_id)
);

create table teaches(
    ID VARCHAR(50) REFERENCES instructor(ID),
